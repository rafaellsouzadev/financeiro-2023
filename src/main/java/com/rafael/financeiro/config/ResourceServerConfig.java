...
public class ResourceServerConfig extends WebSecurityConfigurerAdapter implements HttpSessionListener {
	...
	public JwtDecoder jwtDecoder() {
		var secretKey = new SecretKeySpec("Aluc@rds1528?Meta%data021&Overhill".getBytes(), "HmacSHA256");
